...
If you are new to iCOW, start with the [Background](../getting-started/background.qmd) for physical intuition, or the [Tutorial](../getting-started/tutorial.qmd) for a hands-on introduction.
