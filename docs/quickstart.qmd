...
The "stick-breaking" parameterization guarantees that all physical constraints are satisfied automatically (see [Architecture](developers/architecture.qmd) for details).
...
- **Understand the math**: [Equations](equations.qmd) describes every cost and damage formula
...
- **Understand the design**: [Architecture](developers/architecture.qmd) explains the module structure and policy reparameterization
