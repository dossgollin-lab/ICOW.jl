...
The surge distribution is a stationary GEV, parameterized by location, scale, and shape in the `EADScenario`.
The expected damage is integrated over this distribution using the integration method on `EADConfig`:
...
::: {.callout-tip}
See [Details](details.qmd) for worked examples with visualizations.
:::
